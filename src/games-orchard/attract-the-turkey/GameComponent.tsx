...
function AttractTheTurkeyGame(props: Partial<GameControlProps>) {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center p-4 pb-24 bg-gradient-to-br from-amber-100 via-orange-200 to-yellow-300">
      ...
      {sessionStatus === "CONNECTED" &&
        isWebRTCReady && (
          <div className="flex flex-col items-center mt-8 md:mt-8 md:relative fixed bottom-4 left-1/2 transform -translate-x-1/2 md:transform-none md:left-auto md:bottom-auto z-50">
            ...
            <div className="text-sm text-amber-800 mt-2 font-bold bg-white md:bg-transparent px-2 py-1 rounded">
              Hold to Gobble
            </div>
          </div>
        )}
