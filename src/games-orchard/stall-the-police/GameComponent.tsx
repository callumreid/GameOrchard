...
function StallThePoliceGame(props: Partial<GameControlProps>) {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center p-4 pb-24 bg-gradient-to-br from-red-900 via-gray-800 to-black">
        ...
        isWebRTCReady && (
          <div className="flex flex-col items-center mt-8 md:mt-8 md:relative fixed bottom-4 left-1/2 transform -translate-x-1/2 md:transform-none md:left-auto md:bottom-auto z-50">
            <button
              ...
              className={`w-20 h-20 md:w-32 md:h-32 sm:md:w-40 sm:md:h-40 rounded-full border-4 border-red-400 transition-all duration-150 shadow-lg ${
                isPTTUserSpeaking
            ...
            <div className="text-sm text-red-800 mt-2 font-bold bg-white md:bg-transparent px-2 py-1 rounded">
              Hold to Stall
            </div>
          </div>
        )}
